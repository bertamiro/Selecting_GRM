...
\\
Alex Sanchez-Pla\textsuperscript{\getAff{Universitat de Barcelona (UB)}, \getAff{Vall d'Hebron Research Institute (VHIR)}}\textsuperscript{*},
Berta Miro\textsuperscript{\getAff{Vall d'Hebron Research Institute (VHIR)}}\\
\bigskip
\textbf{\getAff{Universitat de Barcelona (UB)}}Departament of Genetics Microbiology and Statistics, Avda Diagonal 645,
Barcelona, 08028\\
\textbf{\getAff{Vall d'Hebron Research Institute (VHIR)}}Statistics and Bioinformatics Unit (UEB), Passeig de la Vall d'Hebron
