...
\#\#Synthetic dataset generation for the simulation studies The R
package simstudy was used to create 4 artificial datasets by using the
splines method
...
\#\#Measures of performance for the heuristic method with synthetic
datasets Sensitivity, specificity and accuracy for the heuristic model
were measured for the 4 synthetic datsets (Figure {[}ssa{]}) with
...
\begin{figure}
\centering
\includegraphics{senspecacc.png}
\caption{ssa}
\end{figure}
