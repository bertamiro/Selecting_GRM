...
pb1 <- ggplot(data = dt1x, aes(x=methylation, y=expression30)) +
...
#variable visualization
pb2 <- ggplot(data = dt2x, aes(x=methylation, y=expression184)) +
  geom_point(color = "grey35", size = 0.75) +
  geom_hline(yintercept = 3.34, color= "grey70", size=0.5)+geom_hline(yintercept = 6.67, color= "grey70", size=.5)+
  geom_vline(xintercept = 0.34, color= "grey70", size=.5)+geom_vline(xintercept = 0.67, color= "grey70", size=.5)+
  #geom_smooth(se=FALSE, color="blue", size = 1, method = "auto") +
...
#variable visualization
pb3 <- ggplot(data = dt3x, aes(x=methylation, y=expression282)) +
  geom_point(color = "grey35", size = 0.75) +
  geom_hline(yintercept = 3.34, color= "grey70", size=0.5)+geom_hline(yintercept = 6.67, color= "grey70", size=.5)+
  geom_vline(xintercept = 0.34, color= "grey70", size=.5)+geom_vline(xintercept = 0.67, color= "grey70", size=.5)+
  #geom_smooth(se=FALSE, color="blue", size = 1, method = "auto") +
...
#variable visualization
pb4 <- ggplot(data = dta1x, aes(x=methylation, y=expression401)) +
...
#variable visualization
pb5 <- ggplot(data = dta2x, aes(x=methylation, y=expression601)) +
...
#variable visualization
pb6 <- ggplot(data = dta3x, aes(x=methylation, y=expression901)) +
  geom_point(color = "grey35", size = 0.75) +
  geom_hline(yintercept = 3.34, color= "grey70", size=0.5)+geom_hline(yintercept = 6.67, color= "grey70", size=.5)+
  geom_vline(xintercept = 0.34, color= "grey70", size=.5)+geom_vline(xintercept = 0.67, color= "grey70", size=.5)+
  #geom_smooth(se=FALSE, color="blue", size = 1, method = "auto") +
...
#variable visualization
pb7 <- ggplot(data = dta4x, aes(x=methylation, y=expression1400)) +
...
#variable visualization
pb8 <- ggplot(data = dta5x, aes(x=methylation, y=expression1700)) +
  geom_point(color = "grey35", size = 0.75) + xlim(0,1)+
  geom_hline(yintercept = 3.34, color= "grey70", size=0.5)+geom_hline(yintercept = 6.67, color= "grey70", size=.5)+
  geom_vline(xintercept = 0.34, color= "grey70", size=.5)+geom_vline(xintercept = 0.67, color= "grey70", size=.5)+
  #geom_smooth(se=FALSE, color="blue", size = 1, method = "auto") +
...
```{r}
figure2 <- ggarrange(pb1, pb2, pb3, pb4, pb5, pb6, pb7, pb8,
