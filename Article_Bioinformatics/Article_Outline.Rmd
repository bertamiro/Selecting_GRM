---
title: |
    | _A heuristic algorithm to select genes regulated by methylation_
...
4. Però perquè estem aquí (quin és el context de l'article?)
				...
				- Fins i tot si la relació és lineal convé no oblidar que l’ús de “r” es bastant trist només detecta si existeix relació ( __COMPTE: NO PODRIA SER QUE AQUI AIXÒ SIGUI UN AVENTATGE?__ Al cap i a la fi si estem buscant candidats amb detectar els possibles n'hi pot haver rou.
...
- _Massie (2017). The importance of DNA methylation in prostate cancer development_: Analitza relaco expressio en gens de 17 estudis i fa una mena de consens agafant els que mstren canvis en més de tres dels estudis. Proporciona correlacions entre sondes més que entre gens.
...
[_Això podria ser un article en si mateix però aquí també hi ha d'anar__]
...
- Problemes en la comparació amb altres mètodes: 
    ...
    - L'aplicació a datasets la página de "Pubmeth" (http://www.pubmeth.org/) donde tienes la opción de buscar listas de genes (http://pubmeth.biobix.be/temp/static/) que se sepan metilados y en qué tipo de cáncer como la opción de revisar si tu gen de interés está metilado en cáncer y en qué tipo (http://pubmeth.biobix.be/mate/gene_cancer.html).
